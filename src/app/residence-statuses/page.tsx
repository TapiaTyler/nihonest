...
export const metadata: Metadata = {
  ...
  description:
    "Browse a limited set of draft residence-status records linked to official Japanese sources.",
};
    ...
    <div className="page-shell py-16 sm:py-24">
      <header className="max-w-3xl">
        ...
        <p className="mt-6 text-lg leading-8 text-slate-600">
          This deliberately limited collection demonstrates how Nihonest organizes residence-status information. It does not determine eligibility or whether a particular activity is permitted.
        </p>
      </header>

      <aside className="mt-8 max-w-3xl rounded-2xl border border-amber-200 bg-amber-50 p-5 text-sm leading-6 text-amber-950">
        <strong>Draft coverage:</strong> These sample records are incomplete and provided for product development. Confirm current requirements with the Immigration Services Agency or a qualified professional.
      </aside>
