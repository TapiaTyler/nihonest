...
export const guidanceDiscoveryRecordSchema = z.object({
  ...
  contentImpacts: z.array(z.object({
    kind: z.enum(["article", "residence-status", "glossary-term", "faq", "group", "journey", "new-article", "geography-schema", "local-guidance-schema", "location-ui", "document-schema", "document-ui", "document-example"]),
    id: stableIdSchema,
    action: z.enum(["create", "update", "review", "pilot"]),
