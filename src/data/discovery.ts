...
export const articleGroups = [
  ...
  articleGroupSchema.parse({ id: "working-in-japan", title: "Working in Japan", description: "Workplace language, employment contracts, pay and time, insurance and work injury, workplace help, side jobs, freelance protections, employment endings, and connected immigration and tax questions.", articleIds: ["understanding-language-requirements-and-certifications-for-jobs-in-japan", "understanding-your-employment-contract-and-working-conditions", "wages-working-hours-overtime-and-paid-leave", "employment-insurance-social-insurance-and-work-injury", "workplace-harassment-safety-and-getting-help", "side-work-and-freelancing-on-a-work-status", "side-jobs-and-multiple-employers-in-japan", "freelance-contracts-and-client-obligations-in-japan", "tax-for-side-work-and-sole-proprietors", "resigning-dismissal-and-fixed-term-contract-endings", "notifying-immigration-about-work-contract-changes"] }),
  articleGroupSchema.parse({ id: "transport-safety-and-emergencies", title: "Transport, safety, and emergencies", description: "Driving authority, licence conversion, vehicle ownership, traffic and bicycle rules, emergency calls, and disaster readiness with national and local boundaries kept visible.", articleIds: ["driving-in-japan-with-a-foreign-or-international-license", "converting-a-foreign-drivers-license-in-japan", "buying-registering-and-insuring-a-vehicle-in-japan", "driving-rules-and-traffic-accidents-in-japan", "bicycle-rules-registration-and-accidents-in-japan", "calling-police-fire-and-ambulance-services-in-japan", "preparing-for-disasters-and-evacuation-in-japan"] }),
  articleGroupSchema.parse({ id: "daily-life-and-local-community", title: "Daily life and local community", description: "Utilities and internet, address-specific waste disposal, consumer contracts and help, shared-space living, practical Japanese learning, and local support without presenting local custom as universal law.", articleIds: ["setting-up-electricity-gas-water-and-home-internet", "sorting-household-waste-and-arranging-disposal", "consumer-contracts-cancellations-and-getting-help", "living-in-a-japanese-neighborhood-and-shared-spaces", "finding-japanese-language-and-local-support", "finding-housing-and-moving-in", "getting-a-phone-number-in-japan"] }),
] as const;
