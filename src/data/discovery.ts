...
export const articleGroups = [
  articleGroupSchema.parse({ id: "study-in-japan", title: "Study in Japan", description: "School planning, Student status, institutional onboarding, and rules specific to international students.", articleIds: ["planning-your-studies-in-japan", "short-term-study-in-japan", "student-visa-and-certificate-of-eligibility", "preparing-to-enter-japan", "completing-school-arrival-procedures", "working-part-time-on-student-status", "continued-job-hunting-after-study"] }),
  ...
  articleGroupSchema.parse({ id: "professional-work", title: "Professional work", description: "Individual work statuses for academic, creative, religious, media, regulated, research, teaching, technical, transfer, and care roles.", articleIds: ["visa-and-status-of-residence-explained", "choosing-a-work-status-and-coe", "preparing-for-long-term-entry-to-japan", "professor-status", "artist-status", "religious-activities-status", "journalist-status", "legal-accounting-services-status", "medical-services-status", "researcher-status", "instructor-status", "engineer-specialist-humanities-international-services-status", "intra-company-transferee-status", "nursing-care-status", "side-work-and-freelancing-on-a-work-status", "notifying-immigration-about-work-contract-changes"] }),
  ...
  articleGroupSchema.parse({ id: "skilled-and-sector-work", title: "Skilled and sector-based work", description: "Entertainment, specialized skilled occupations, Specified Skilled Worker, and Technical Intern Training routes.", articleIds: ["visa-and-status-of-residence-explained", "choosing-a-work-status-and-coe", "preparing-for-long-term-entry-to-japan", "entertainer-status", "skilled-labor-status", "specified-skilled-worker-status", "technical-intern-training-status"] }),
  articleGroupSchema.parse({ id: "family-and-long-term-residence", title: "Family and long-term residence", description: "Dependent, spouse and child, Long-Term Resident, and Permanent Resident guidance organized by the relationship or position supporting residence.", articleIds: ["visa-and-status-of-residence-explained", "preparing-for-long-term-entry-to-japan", "dependent-family-stay-visa", "spouse-or-child-of-japanese-national", "spouse-or-child-of-permanent-resident", "long-term-resident-status", "permanent-residence-in-japan"] }),
  ...
  articleGroupSchema.parse({ id: "taxes-and-resident-responsibilities", title: "Taxes and resident responsibilities", description: "Ongoing obligations after arrival: income and resident tax, side work, immigration notifications, status renewal or change, and departure.", articleIds: ["income-and-resident-tax-after-moving-to-japan", "filing-a-japanese-income-tax-return", "side-work-and-freelancing-on-a-work-status", "notifying-immigration-about-work-contract-changes", "renewing-or-changing-your-status-of-residence", "leaving-japan-and-closing-out-procedures"] }),
] as const;
...
export const guidedJourneys = [
  guidedJourneySchema.parse({
    ...
    phases: [
      { id: "plan", title: "Plan your studies", steps: [articleStep("planning-your-studies-in-japan")] },
      ...
      { id: "work-and-transition", title: "Work and later transitions", steps: [conditionalStep("working-part-time-on-student-status", "If you plan to undertake paid work", ["student-status"]), conditionalStep("continued-job-hunting-after-study", "If you graduate and qualify to continue job hunting", ["student-status"])] },
    ],
  }),
  guidedJourneySchema.parse({
  ...
  guidedJourneySchema.parse({
    ...
    description: "Choose the relevant skilled or sector route, then follow its focused employment, entry, and settlement sequence.",
    introduction: "Entertainer, Skilled Labor, Specified Skilled Worker, and Technical Intern Training are alternatives rather than consecutive steps.",
    routes: [
      ...
      { id: "technical-intern-training", title: "Technical Intern Training", description: "Activity within the regulated technical-intern framework.", articleId: "technical-intern-training-status" },
    ],
    phases: [
      { id: "understand", title: "Understand work-status residence", steps: [articleStep("visa-and-status-of-residence-explained"), articleStep("choosing-a-work-status-and-coe")] },
  ...
  guidedJourneySchema.parse({
    ...
    phases: [
      { id: "understand", title: "Understand relationship-based residence", steps: [articleStep("visa-and-status-of-residence-explained")] },
